      ...
      >
        <div className="relative flex-1 rounded-2xl bg-slate-50/90 ring-1 ring-slate-200/80">
          <select
            ...
            className="w-full cursor-pointer appearance-none rounded-2xl bg-transparent py-4 pl-5 pr-12 text-left text-[15px] font-semibold text-slate-800 outline-none transition hover:bg-slate-100/80"
        ...
        <button
          type="submit"
          className="flex min-h-[52px] shrink-0 items-center justify-center gap-2 rounded-2xl bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] px-6 text-[15px] font-bold text-white shadow-btn-cta transition hover:brightness-105 active:scale-[0.98] md:px-8"
        >
