...
export function CategoriesSection() {
  ...
  return (
    <section id="kategorije" className="py-12 lg:py-16">
      <div className="mb-8 flex items-end justify-between gap-4">
        <div>
          <p className="mb-2 text-xs font-bold uppercase tracking-[0.18em] text-blue-600">Popularne usluge</p>
          <h2 className="text-2xl font-black tracking-tight text-slate-950 sm:text-3xl">Pronađi pravu uslugu za svoj dom</h2>
        </div>
      </div>
        ...
        {shown.map((title) => (
          ...
          >
            ...
            <div className="p-3 sm:p-4">
              <h3 className="line-clamp-2 text-sm font-bold text-slate-900 sm:text-base">{title}</h3>
