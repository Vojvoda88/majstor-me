...
export function HomeHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 mb-6 border-b border-slate-200/80 bg-white/80 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-10 md:flex">
          <a href="#kako-radi" className="font-medium text-slate-600 transition hover:text-slate-900">
            Kako radi
          </a>
          <a href="#kategorije" className="font-medium text-slate-600 transition hover:text-slate-900">
            Kategorije
          </a>
          <a href="#gradovi" className="font-medium text-slate-600 transition hover:text-slate-900">
            Gradovi
          </a>
        </nav>
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link
            href="/login"
            className="rounded-2xl px-5 py-3 font-semibold text-slate-700 transition hover:bg-slate-100"
          >
            Prijava
          </Link>
          <Link
            href="/register"
            className="rounded-2xl bg-blue-600 px-5 py-3 font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700"
          >
            Registracija
          </Link>
        </div>
        ...
        <button
          ...
          className="inline-flex rounded-2xl border border-slate-200 bg-white p-3 md:hidden"
          aria-label="Meni"
        >
