...
/** Tip slike isključivo iz sadržaja fajla (za mobitel gde `File.type` često bude prazan). */
export function detectImageMimeFromBuffer(buffer: Buffer): (typeof VALID_IMAGE_TYPES)[number] | null {
